                ...
                >
                    <Col2Auto>
                        ...
                        <Col2Auto>
                            ...
                            <Text>Precio</Text>
                            <Text useT={false}>{parseNumberCount(data?.price ?? 0)}</Text>
                            <Text>Estatus</Text>
                            <Text useT={false}>{parseStatus(data?.status)}</Text>
                            <Text>Descripcion</Text>
                            <Text useT={false} className='text-description'>{data?.description}</Text>
                            <Text>Fecha de creacion</Text>
                            <Text useT={false}>{parseDateTimeFormat_DD_MM_YY(data?.createdAt)}</Text>
                            <Text>Fecha de actualizacion</Text>
                            <Text useT={false}>{parseDateTimeFormat_DD_MM_YY(data?.updatedAt)}</Text>
                        </Col2Auto>
                    </Col2Auto>
                </LayoutSimple>
            </LayoutDashboard>
