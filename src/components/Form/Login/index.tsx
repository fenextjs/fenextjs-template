...
import { Button, ErrorComponent, Form, InputPassword, InputText
} from '@/ui-fenextjs'
...
export const FormLogin = ({ }: FormLoginProps) => {
    const {data,onChangeData,validatorData,onSubmitData,loaderSubmit,dataError,isValidData} = useFormLogin({})
    return <>
